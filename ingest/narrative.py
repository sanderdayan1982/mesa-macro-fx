...
SPEC: Dict[str, dict] = {
    ...
    "jpy": {
        ...
        "issuance": {"gross": ("fiscal", "derived", "mof_issued_gross"), "redemptions": ("fiscal", "derived", "mof_redeemed_net"), "freq": "daily",
                     "gross_label": "emisión del MoF por fecha de emisión (JGB + letras) y reembolsos netos de la cartera del BoJ"},
