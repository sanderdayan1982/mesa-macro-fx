...
| B — v0.4 base | 0.43 | 44 | 0.692 / 0.1708 | -1.544 / -0.8002 | 0.12 / 0.21 / 0.11 | insuficiente | -0.007 (0.969) | 0.109 (0.5182) | None (None) | 0.477 |
| C — candidato ronda 1 | 0.0 | 0 | insuficiente (0 semanas con dato) | | | | | | | |

- B · `treasury_5d` ← hist:treasury_realized_daily · daily5 · retraso de publicación 0 d · cobertura 0.431 · conciliación: 財政等要因 realizado (速報/確報) = −Δ cuenta del gobierno
- C · `net_issuance_5d` ← hist:net_issuance_private_daily · daily5 · retraso de publicación 1 d · cobertura 0.0 · conciliación: emisión neta del MoF por fecha de emisión, neta de mei

**Selección (escalera de la ronda 1): A** — sin evidencia B y la variante v0.4 no cubre la era (cobertura 0.431) → se mantiene v0.3
